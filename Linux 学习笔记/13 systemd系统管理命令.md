...
> 转载自:  http://www.ruanyifeng.com/blog/2016/03/systemd-tutorial-commands.html 
...
```
# whereis systemd systemd: 
/usr/lib/systemd /etc/systemd /usr/share/systemd /usr/share/man/man1/systemd.1.gz
# whereis systemctlsystemctl: 
/usr/bin/systemctl /usr/share/man/man1/systemctl.1.gz
```
